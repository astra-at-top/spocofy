    ...
    return (
        <div className="p-6 font-firacode">
            ...
            <div className="hero-section bg-purple-500 text-white p-8 shadow-lg mb-8">
                ...
                <Link to="/dashboard/search" className="bg-white text-purple-500 px-4 py-2 font-semibold hover:bg-gray-200 transition-colors duration-200">
                    Start Searching
                </Link>
            </div>
                    ...
                    <ul className="space-y-2">
                        {playlists.slice(0, 5).map((playlist) => (
                            <li key={playlist._id} className="bg-gray-700 p-4">
                                <Link to={`/dashboard/playlist/${playlist._id}`} className="text-purple-300 hover:text-purple-500 transition-colors duration-200">
                                    {playlist.name}
                                </Link>
                            </li>
                        ))}
                    </ul>
                    <Link to="/dashboard/playlist" className="mt-4 inline-block text-purple-400 hover:text-purple-600 transition-colors duration-200">
                        View all playlists
                    </Link>
                </div>
                <div className="bg-gray-800 p-6 shadow-lg">
                    ...
                    <div className="space-y-2">
                        <Link to="/dashboard/search" className="block bg-gray-700 p-4 text-purple-300 hover:text-purple-500 transition-colors duration-200">
                            Search for music
                        </Link>
                    </div>
                </div>
