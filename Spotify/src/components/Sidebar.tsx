    ...
    <div className={`font-firacode sidebar bg-gray-950 text-white w-64 min-h-full ${isSmallScreen ? 'fixed' : 'relative'} left-0 bottom-0 top-0 overflow-y-auto transition-all duration-300 z-20 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 `}>
      ...
      <nav className="py-8">
        <ul className="space-y-2">
          <li>
            <Link to="/dashboard" className="flex items-center px-6 py-2 hover:border-l-4 hover:border-purple-500 transition-all duration-200">
          ...
          <li>
            <Link to="/dashboard/search" className="flex items-center px-6 py-2 hover:border-l-4 hover:border-purple-500 transition-all duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <Link to="/dashboard/playlist" className="flex items-center px-6 py-2 hover:border-l-4 hover:border-purple-500 transition-all duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="playlists  border-t pt-8 border-gray-800">
        ...
        <ul className="space-y-2">
          {Playlists.slice(0, 5).map((playlist) => (
            <li key={playlist._id}>
              <Link to={`/dashboard/playlist/${playlist._id}`} className="flex items-center px-6 py-2 hover:border-l-4 hover:border-purple-500 transition-all duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                </svg>
                {playlist.name}
